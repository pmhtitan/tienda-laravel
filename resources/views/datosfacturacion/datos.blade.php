...
@section('title', 'Datos Facturacion')
...
<div class="container">
    <div class="row justify-content-center">
        ...
        @include('includes.message')
            <div class="card">
                <div class="card-header text-center text-uppercase"><strong>Mis datos de Facturación</strong></div>
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="@if($datosexisten) {{ $datosfacturacion->email }}  @else {{ Auth::user()->email }} @endif" required autocomplete="email">
